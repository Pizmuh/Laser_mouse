...
while(True):
    ...
    # zečena lower_range = np.array([30, 30, 30]) # najnižja barva ki jo zazna
    # zečena upper_range = np.array([255, 255, 255]) # najvišja barva ki jo lahko zazna
